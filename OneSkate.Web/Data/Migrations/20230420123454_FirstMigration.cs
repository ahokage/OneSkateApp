    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RacerRaces", x => new { x.RacerId, x.RaceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Results", x => new { x.RacerId, x.RaceId });
                    table.ForeignKey(
                        name: "FK_Results_Racers_RacerId",
                        column: x => x.RacerId,
                        principalTable: "Racers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Racers_ClubId",
                table: "Racers",
                column: "ClubId");

            migrationBuilder.CreateIndex(
                name: "IX_Races_VenueId",
                table: "Races",
                column: "VenueId");
